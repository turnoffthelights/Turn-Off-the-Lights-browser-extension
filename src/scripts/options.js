...
function removedynamic(){
	var dynarray = ["fishtanks", "blocks", "raindrops", "clouds", "space", "smoke", "flyingdots", "storm", "triangle", "stars", "aquarium"];
...
function dynamictest(){
	...
	if($("dynamic1").checked == true){ setdynamiclabel(chrome.i18n.getMessage("desdynamicfishtank")); }else if($("dynamic2").checked == true){ setdynamiclabel(chrome.i18n.getMessage("desdynamicblocks")); }else if($("dynamic3").checked == true){ setdynamiclabel(chrome.i18n.getMessage("desdynamicraindrops")); }else if($("dynamic4").checked == true){ setdynamiclabel(chrome.i18n.getMessage("desdynamiccloud")); }else if($("dynamic5").checked == true){ setdynamiclabel(chrome.i18n.getMessage("desdynamicspace")); }else if($("dynamic6").checked == true){ setdynamiclabel(chrome.i18n.getMessage("desdynamicsmoke")); }else if($("dynamic7").checked == true){ setdynamiclabel(chrome.i18n.getMessage("desdynamicdotscolor")); }else if($("dynamic8").checked == true){ setdynamiclabel(chrome.i18n.getMessage("desdynamicstorm")); }else if($("dynamic9").checked == true){ setdynamiclabel(chrome.i18n.getMessage("desdynamictriangulation")); }else if($("dynamic10").checked == true){ setdynamiclabel(chrome.i18n.getMessage("desdynamicstars")); }else if($("dynamic11").checked == true){ setdynamiclabel(chrome.i18n.getMessage("desdynamicaquarium")); }
